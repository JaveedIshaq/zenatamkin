...
class WordPressLearning extends StatelessWidget {
  ///
  const WordPressLearning({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<AppViewModel>.reactive(
      ...
      onModelReady: (AppViewModel model) =>
          model.requestWPYTvideos(context: context),
            ...
            children: [
              ...
              Center(
                  child: model.isBusy
                      ...
                      : LecturesList(list: model.wpYtlist!.data!)),
            ],
          ),
        ),
      ),
